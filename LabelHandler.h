...
#define _PROJ_WORD_LABELA "LABEL"
#define _PROJ_WORD_LABEL _T( _PROJ_WORD_LABELA )
#define _PROJ_WORD_EQUA "EQU"
#define _PROJ_WORD_EQU _T( _PROJ_WORD_EQUA )
#define _PROJ_WORD_ORGA "ORG :"
#define _PROJ_WORD_ORG _T( _PROJ_WORD_ORGA )
#define _PROJ_WORD_BINFILEA "BinFile :"
#define _PROJ_WORD_BINFILE _T( _PROJ_WORD_BINFILEA )
#define _PROJ_WORD_DATAA "DATA"
#define _PROJ_WORD_DATA _T( _PROJ_WORD_DATAA )
